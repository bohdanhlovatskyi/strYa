'''
Module that contains function to visualise the sensor with OpenGL and pygame.
'''
...
def init():
    '''
    Initialize the object to visualize.
    '''
...
def drawtext(position, textstring):
    '''
    Draw the text on the visualization.
    '''
...
def draw(ax, ay, az, screen, i, str_condition):
    '''
    Draw the object of visulization.
    '''
...
def Quaternion_to_Euler(Q):
    '''
    Return the Euler angles that are gotten from quaternion.
    '''
...
def read_data(path):
    '''
    Read and normalize data for visualization.
    '''
